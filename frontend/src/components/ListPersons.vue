...
const user = ref([]);
const error = ref('');
// console.log("user in ListPersons: ", user);
...
function displayTable(page, dataInput) {
    ...
    slicedData.forEach(item => {
        ...
        row.addEventListener("click", () => {
            // console.log("in eventlistener für personalblatt für user: ", item);
    ...
    // console.log("displayTable end with dataInput: ", dataInput);
    // console.log("displayTable end with dataInput.length: ", dataInput.length);
...
function openPersonalblatt(person) {
    // console.log("in openPersonalblatt mit person: ", person);
    router.push({ name: 'personalblatt', params: { id: person.id } }); 
    //console.log("function done");
}

function nextPage() {
    // console.log("in nextPage function with currentPage / totalPages: ", currentPage.value, "/", totalPages.value);
    currentPage.value++;
...
onMounted(async () => {
    ...
    displayTable(currentPage.value, newData);
...
////////////////////////////////////////////////////////////////////////////////////////////
// PROLEM: sortierung wird übernommen, aber man muss trz in der spalte sortieren drücken ///
////////////////////////////////////////////////////////////////////////////////////////////
...
function sortTable(n) {
    ...
    console.log("sortedValue: ", sortedData.value);
    ...
    // console.log("sortedData before displayTable: ", sortedData);
    ...
    displayTable(currentPage.value, sortedData.value); // Pass sorted data to displayTable
}
